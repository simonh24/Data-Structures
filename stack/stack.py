...
3. What is the difference between using an array vs. a linked list when 
   ...
   Stacks utilizing LinkedLists can only be changed from the end of the queue, which makes it faster and easier to remove from. An array can be altered in any way, including from the middle, which makes it take longer to remove from. Arrays are also limited to the size provided, while LinkedLists are not.
"""
